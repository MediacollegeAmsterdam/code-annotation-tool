...
4. Voer het commando "Explain code visually" uit via de context window(rechtermuisknop)

**Verwacht Resultaat:**
- Commando verschijnt in de context window(rechtermuisknop)
...
3. Voer het commando "Explain code visually" uit
...
3. Selecteer andere code en voer "Explain code visually" uit
